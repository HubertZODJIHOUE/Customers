...
import com.example.customers.service.EmployeeService;
...
public class EmployeeRessource {
    ...
    public ResponseEntity<Employee> addEmployee(@RequestBody Employee employee){
        Employee newmployee= employeeService.addEmployee(employee);
        return new ResponseEntity<>(newmployee ,HttpStatus.CREATED);
    }
